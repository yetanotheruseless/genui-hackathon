/**
 * Provider-agnostic LLM client for the dungeon-demo server.
 *
 ...
 * fails, or the response doesn't match the schema, this throws. There
 * is NO fallback path. Silent canned content is worse than a loud error
 * during development.
 */
